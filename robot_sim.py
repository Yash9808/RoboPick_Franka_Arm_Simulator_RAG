...
def robot_chatbot(user_input: str):
    ...
    if "pick" in user_input:
        ...
        return "✅ Pick and place executed.", (sim_img, traj_img)
    ...
    try:
        ...
        if len(values) == 7:
            ...
            sim_img = capture_view()
            traj_img = plot_trajectory()
            return "✅ Moved to specified joint angles.", (sim_img, traj_img)
    except Exception:
        pass

    return "🤖 Command not recognized. Try 'pick', 'place', or provide 7 joint angles.", (capture_view(), None)
